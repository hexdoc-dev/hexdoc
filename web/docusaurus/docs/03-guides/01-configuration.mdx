...
Most file paths in the `hexdoc.toml` file are resolved relative to the location of the config file, _not_ the working directory of the `hexdoc` command or the root of the Git repository.
