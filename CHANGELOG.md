...
* A tree of redirects for categories, entries, and pages with anchors are now generated by default for web books. These redirects include OpenGraph tags for generating Discord embeds.
